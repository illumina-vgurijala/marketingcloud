...
export default class DLWC_LookUp extends LightningElement {
...
// STYLE EXPRESSIONS
    ...
    get getListboxClass() {
        let classes = '';
        if(this.hasResults()) { // codescanfix- A conditionally executed single line should be denoted by indentation
            classes = 'slds-listbox slds-listbox_vertical slds-dropdown slds-dropdown_fluid ';
    ...
    get selectionListClass() {
        if(this.hasSelection()){ //codescanfix - A conditionally executed single line should be denoted by indentation

...
(function() {
  ...
  Gauge = (function(_super) {
    ...
    Gauge.prototype.options = {
      ...
      fontSize: 40,
      limitMax: false,
      percentColors: [[0.0, "#76B06F"], [0.50, "#8BC380"], [1.0, "#8BC380"]]
    };
    ...
    Gauge.prototype.render = function() {
      ...
      this.ctx.beginPath();
      this.ctx.arc(w, h, this.radius, (1 + this.options.angle) * Math.PI, displayedAngle+.02, false);

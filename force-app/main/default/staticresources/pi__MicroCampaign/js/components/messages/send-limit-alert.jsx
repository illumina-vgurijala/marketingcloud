...
export default class SendLimitAlert extends React.Component {
    ...
    render() {
        ...
        if (numberOfRecipients > MaximumEngageEmailRecipients) {
            statusText = `Can't send email to more than ${MaximumEngageEmailRecipients} recipients. Remove some recipients.`

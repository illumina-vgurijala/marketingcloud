 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
      ...
      function createPaginationElements() {
        ...
        htmlBuffer.push("<select id='tablePagination_rowsPerPage' class='moreCategoriesSelect'><option value='5'>5</option></select>");
        ...
        htmlBuffer.push("<span id='tablePagination_firstPage'>First</span>");

        htmlBuffer.push("<span><img id='tablePagination_prevPage' src='"+defaults.prevArrow+"'></span>");

        htmlBuffer.push("<span>Page</span>");

        htmlBuffer.push("<span><input id='tablePagination_currPage' type='input' value='"+currPageNumber+"' size='1'></span>");

        htmlBuffer.push("<span>of</span> <span id='tablePagination_totalPages'>"+totalPages+"</span>");

        htmlBuffer.push("<span><img id='tablePagination_nextPage' src='"+defaults.nextArrow+"'></span>");

        htmlBuffer.push("<span id='tablePagination_lastPage'>Last</span>");
